    ...
    <div className="body w-full h-screen items-center justify-center flex bg-emerald-50 bg-transparent">
        <div className="main text-center flex bg-black w-96 rounded-2xl h-4/5 text-white z-10">
           <form onSubmit={handleSubmit} className='text-center flex flex-col items-center mt-6'>
             ...
             <input className='w-80 ml-7 rounded-2xl h-11 mb-3 text-black outline-none pl-2' type="name" value={name} onChange={(e)=>setname(e.target.value)} placeholder='Full Name'  />
             <label className='w-80 font-bold mb-2' htmlFor='email'>Email</label>
             <input className='w-80 ml-7 rounded-2xl h-11 mb-3 text-black outline-none pl-2' type="email" value={email} onChange={(e)=>setemail(e.target.value)} placeholder='Enter you email'  />
             <label className='w-80 font-bold mb-2' htmlFor='password'>Password</label>
             <input className='w-80 ml-7 rounded-2xl h-11 mb-11 text-black outline-none pl-2' type="password" value={pass} onChange={(e)=>setpass(e.target.value)} placeholder='Enter you password'  />
             ...
             <Link to="/Login" ><button className='ml-6 text-center text-xs hover:border-b'>Have an account? Login here. </button></Link>
           </form>
